#!/usr/bin/env python3
"""
Monitor the progress of the scraper by checking the Excel file
"""
...
def check_progress():
    ...
    try:
        ...
        # Count processed medications (those with content in column G - Full Information)
